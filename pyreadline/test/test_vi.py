...
class Tests(unittest.TestCase):
    ...
    def test_pos_back_short(self):
        ...
        self.assertEqual(0, vi_pos_back_short('abc  def... u', 5))
        self.assertEqual(
            11, vi_pos_back_short('abc def... ghi...', 16, count=2))
    ...
    def test_pos_find_char_forward(self):
        ...
        self.assertEqual(
            12, vi_pos_find_char_forward('abc def abc def', 'd', count=2))
    ...
    def test_pos_find_char_backward(self):
        ...
        self.assertEqual(
            -1, vi_pos_find_char_backward('abc def', 'd', 6, count=2))
        self.assertEqual(
    ...
    def test_pos_to_char_forward(self):
        ...
        self.assertEqual(
            11, vi_pos_to_char_forward('abc def abc def', 'd', count=2))
    ...
    def test_pos_to_char_backward(self):
        ...
        self.assertEqual(
            -1, vi_pos_to_char_backward('abc def', 'd', 6, count=2))
        self.assertEqual(
